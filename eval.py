'''
Descripttion: test the model
version: 1.0
Author: Assassin 567
Date: 2021-11-03 10:40:02
LastEditors: Hello KG
LastEditTime: 2021-11-06 11:16:43
'''
...
parser.add_argument('--dataset', type=str, default='YAGO1830', help='specify data set')
...
parser.add_argument('--max_attended_edges', type=int, default=30, help='max number of nodes in attending from horizon')
parser.add_argument('--load_checkpoint', type=str, default='checkpoints_2021_10_1_11_31_53/checkpoint_2.pt', help='train from checkpoints')
...
parser.add_argument('--mongo', action='store_true', default=True, help='save information to mongoDB')
...
if __name__ == "__main__":
    ...
    if args.mongo or args.sqlite:
        dbDriver = DBDriver(useMongo=True, useSqlite=args.sqlite, MongoServerIP=None,
    ...
    if args.load_checkpoint is None:
        ...
        sp2o, p2o = contents.get_sp2o()  #（sub，rel）：tail  
    ...
    CHECKPOINT_PATH = os.path.join(save_dir, 'Checkpoints', os.path.dirname(checkpoint))
    with open(os.path.join(CHECKPOINT_PATH, 'test.log'), 'w') as log_file:
        log_file.write(
